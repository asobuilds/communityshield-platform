...
// Suspect represents a person of interest
type Suspect struct {
	...
	Status          string         `gorm:"default:active" json:"status"` // active, captured, cleared, transferred
	DangerLevel     string         `gorm:"default:medium" json:"dangerLevel"`
	Wanted          bool           `gorm:"default:false" json:"wanted"`
	UnitID          *uuid.UUID     `gorm:"type:uuid" json:"unitId,omitempty"` // Current unit handling suspect
	TransferStatus  string         `gorm:"default:''" json:"transferStatus"`   // pending, approved, rejected
