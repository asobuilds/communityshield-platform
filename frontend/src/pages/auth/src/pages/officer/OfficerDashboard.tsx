...
function OfficerDashboard() {
  ...
  const fetchAssignedCases = async () => {
    try {
      // Fetch cases assigned to this officer (using the officer ID)
      // We'll use a new endpoint: GET /api/v1/officer/cases?officerId=...
      // For simplicity, we'll fetch all cases and filter by assigned officer ID on the client.
      // In production, you'd create a backend endpoint.
